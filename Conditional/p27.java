...
public class p27 {
    public static void main(String[] args) {
        ...
        } else if ((heartRate >= 50 && heartRate <= 60) || (heartRate >= 110 && heartRate <= 130) || (systolic >= 160 && systolic <= 180) || (systolic >= 90 && systolic <= 100) || (temperature >= 101 && temperature <= 103) || (temperature >= 96 && temperature <= 97) || symptomSeverity.equalsIgnoreCase("Severe")) {
            triagePriority = "Urgent";
            if (heartRate == 55 || systolic == 95) {
                waitTime = 20;
            } else {
                waitTime = 15;
            }
