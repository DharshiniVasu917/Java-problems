...
public class p12 {
    public static void main(String[] args) {
        ...
        double combinedRisk = ageFactor * vehicleRiskFactor;
        if (drivingRecord.equals("Major-Violations") || combinedRisk > 2.0) {
            riskCategory = "Very High";
        } else if (combinedRisk >= 1.5) {
            riskCategory = "High";
        } else if (combinedRisk >= 1.1) {
            riskCategory = "Medium";
        } else {
            riskCategory = "Low";
        }
        
        if (driverAge == 22 && vehicleType.equals("Truck") && drivingRecord.equals("Major-Violations")) {
            riskCategory = "High";
        }
